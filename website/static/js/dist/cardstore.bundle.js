...
// website/static/js/src/users.ts
...
// website/static/js/src/fetch.ts
...
function get(url, formValues) {
  ...
  let params = objectToString2(formValues);
  url = url + "?" + params;
  return new Request(url, r);
}
function post(url, formValues) {
  url = removeDoubleSlash(url);
  let r = {
    method: "POST",
    credentials: "same-origin",
...
function handleRequestErrors(response) {
  let serverResponseCodes = [200, 500];
  ...
  manageUsers = createApp({
    ...
    data() {
      return {
        ...
        userData: {
          Active: true
          //New users are always active, because why would you create a new user if they are inactive?
        },
        ...
        //set in mounted by reading hidden input, based on config file value.
        //Hide/show details.
    ...
    methods: {
      ...
      getUsers: function() {
        let data = {};
        fetch(get(this.urls.getUsers, data)).then(handleRequestErrors).then(getJSON).then((j) => {
          let err = handleAPIErrors(j);
          if (err !== "") {
            this.msgLoad = err;
      ...
      setUserIDInOtherVueObjects(userID) {
      ...
      update: function() {
        ...
        fetch(post(this.urls.update, data)).then(handleRequestErrors).then(getJSON).then((j) => {
          let err = handleAPIErrors(j);
          if (err !== "") {
            this.msgSave = err;
            this.msgSaveType = msgTypes.danger;
      ...
      add: function() {
        ...
        fetch(post(this.urls.add, data)).then(handleRequestErrors).then(getJSON).then((j) => {
          let err = handleAPIErrors(j);
          if (err !== "") {
            this.msgSave = err;
            this.msgSaveType = msgTypes.danger;
      ...
      addOrUpdate: function() {
        ...
        if (this.userData.Username === "" || this.userData.Username === void 0) {
      ...
      setTwoFactorAuthEnabled: function(b) {
    ...
    mounted() {
      this.getUsers();
      let minPwdLen = document.getElementById("minPasswordLength").value;
  ...
  modalChangePassword = createApp({
    ...
    methods: {
      ...
      save: function() {
        ...
        fetch(post(this.urls.changePassword, data)).then(handleRequestErrors).then(getJSON).then((j) => {
          let err = handleAPIErrors(j);
          if (err !== "") {
            this.msg = err;
            this.msgType = msgTypes.danger;
          ...
          let changedOwnPassword = j.Data.ChangedOwnPassword;
  ...
  modalForceLogout = createApp({
    ...
    methods: {
      ...
      forceLogout: function() {
        ...
        fetch(post(this.urls.forceLogout, data)).then(handleRequestErrors).then(getJSON).then((j) => {
          let err = handleAPIErrors(j);
          if (err !== "") {
            this.msg = err;
            this.msgType = msgTypes.danger;
          ...
          this.msgType = msgTypes.success;
          setTimeout(() => {
            let elem = document.getElementById("modal-forceLogout");
            let modal = import_bootstrap.Modal.getInstance(elem);
            modal.hide();
            this.msg = "";
            this.msgType = "";
            this.submitting = false;
  ...
  modalActivate2FA = createApp({
    ...
    data() {
      return {
        ...
        //a 6 digit number but stored as text to make sure leading zeros aren't removed
        show2FAInfoOnly: true,
        //show info, not the enrollment QR code.  so user can understand what 2fa is.
        retrievingBarcode: false,
        //true when making request to get the enrollment qr code
        //Form submission stuff.
        submitting: false,
        msg: "",
        msgType: "",
    ...
    methods: {
      ...
      getBarcode: function() {
        ...
        fetch(get(this.urls.getQRCode, data)).then(handleRequestErrors).then(getJSON).then((j) => {
          let err = handleAPIErrors(j);
          if (err !== "") {
            this.msg = err;
            this.msgType = msgTypes.danger;
      ...
      validate: function() {
        ...
        fetch(post(this.urls.verify, data)).then(handleRequestErrors).then(getJSON).then((j) => {
          let err = handleAPIErrors(j);
          if (err !== "") {
            this.msg = err;
            this.msgType = msgTypes.danger;
  ...
  modalDeactivate2FA = createApp({
    ...
    methods: {
      ...
      deactivate: function() {
        ...
        fetch(post(this.urls.deactivate, data)).then(handleRequestErrors).then(getJSON).then((j) => {
          let err = handleAPIErrors(j);
          if (err !== "") {
            this.msg = err;
            this.msgType = msgTypes.danger;
          ...
          setTimeout(() => {
            let elem = document.getElementById("modal-deactivate2FA");
            let modal = import_bootstrap.Modal.getInstance(elem);
            modal.hide();
            this.msg = "";
            this.msgType = "";
  ...
  userProfile = createApp({
    ...
    methods: {
      ...
      getUserData: function() {
        let data = {};
        fetch(get(this.urls.getUserData, data)).then(handleRequestErrors).then(getJSON).then((j) => {
          let err = handleAPIErrors(j);
          if (err !== "") {
            this.msg = err;
            this.msgType = msgTypes.danger;
      ...
      setUserIDInOtherVueObjects: function(userID) {
        modalChangePassword.setUserData(userID);
        modalActivate2FA.setUserData(userID);
        modalDeactivate2FA.setUserData(userID);
      },
