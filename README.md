...
To use the client package to verify a license key in your application, import `github.com/c9845/licensekeys/licensefile` in your `.go` file. See the `client-app.go` example in the `_example` directory at the root of this repo for an idea of how to get started.
